import 'package:e_commerce/controller/auth/verfiycodforget.dart';
...
class Verfiycodefoget extends StatelessWidget {
  const Verfiycodefoget({super.key});

  @override
  Widget build(BuildContext context) {
    veryfiycontrollerforgetim controller = Get.put(veryfiycontrollerforgetim());
